...
const sendToken = (id, email, username) => {
...
const createSendToken = (user, statusCode, res) => {
    const token = sendToken(user._id, user.email, user.username);
...
exports.register = catchAsync(async (req, res, next) => {
    ...
    const { firstName, lastName, email, username, role, phone, dateOfBirth, gender, streetAddress, city, state, zipCode, bio, password, passwordConfirm, passwordChangedAt } = req.body;
